...
public class Enemy extends Ship {
    ...
    public void update(float delta) {
        ...
        if (pos.y > worldBounds.getTop()) {
            ...
            autoShot(delta);
            pos.mulAdd(v, delta);
            if (pos.y < worldBounds.getBottom())
                destroyShipOut(); // Эта строчка взрывает корабли внизу, но взрывы зацикливаются
        }
    }
